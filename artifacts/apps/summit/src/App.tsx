...
const clerkAppearance = {
  ...
  elements: {
    ...
    otpCodeFieldInput: "bg-white border border-slate-200",
    formFieldRow: "",
    main: "",
  },
};
    ...
    <ClerkProvider
      ...
      localization={{
        signIn: {
          start: {
            title: "Welcome back",
            subtitle: "Sign in with your school email to continue",
          },
        },
        signUp: {
          start: {
            title: "Create your summit account",
            subtitle: "School email required (.edu or .org)",
          },
        },
      }}
